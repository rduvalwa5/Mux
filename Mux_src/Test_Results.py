...
songs_count = 8718
artist_count = 486
artist_albums_count = 946
folk_songs = 677
folk_albums = 51
get_max_index_artist = 486
get_max_index_albums = 947
get_max_index_songs = 8719
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 893), \
            ...
            ('Rock', 4328), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 202), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 3491), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1808)]
