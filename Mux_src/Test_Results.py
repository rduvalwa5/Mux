...
genreList = [('Alternative', 3), ('BlueGrass', 157), ('Blues', 483), ('Classical', 43), ('Country', 924), \
            ('Easy Listening', 28), ('Folk', 614), ('Holiday', 97), ('Jazz', 779), ('Latino', 1), ('Pop', 518), ('Regae', 22), \
            ('Rock', 4442), ('RockaBilly', 32), ('Soul', 44), ('Talk', 1), ('TestGenre', 3), ('TexMex', 154), \
            ('Traditional', 23), ('World', 15)]
typeList = [('CD', 3423), ('Download', 3172), ('Tape', 24), ('TestType', 3), ('Vinyl', 1762)]
