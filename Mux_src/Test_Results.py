...
songs_count = 6937
artist_count = 552
artist_albums_count = 899
folk_songs = 576
folk_albums = 47
get_max_index_artist = 578
get_max_index_albums = 994
get_max_index_songs = 6952
...
genreList = [('Alternative',3),('BlueGrass',157),('Blues',434),('Classical',43),('Country',740), \
            ...
            ('Rock',3482),('RockaBilly',33),('Soul',44),('Talk',1),('TestGenre',5),('TexMex',134), \
            ('Traditional',23),('World',15)]
typeList = [('CD',2371),('Download',2838),('Tape',24),('TestType',3),('Vinyl',1699)]
