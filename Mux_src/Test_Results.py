...
songs_count = 9218
artist_count = 493
artist_albums_count = 987
folk_songs = 686
folk_albums = 52
get_max_index_artist = 493
get_max_index_albums = 988
get_max_index_songs = 9221
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 893), \
            ('Easy Listening', 28), ('Folk', 686), ('Holiday', 0), ('Jazz', 787), ('Latino', 0), ('Pop', 559), ('Regae', 23), \
            ('Rock', 4783), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 202), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 3978), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
