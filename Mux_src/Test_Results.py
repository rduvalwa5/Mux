...
songs_count = 10488
artist_count = 518
artist_albums_count = 1090
folk_songs = 677
folk_albums = 51
get_max_index_artist = 519
get_max_index_albums = 1091
get_max_index_songs = 10492
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 803), ('Classical', 59), ('Country', 964), \
            ('Easy Listening', 28), ('Folk', 677), ('Holiday', 0), ('Jazz', 860), ('Latino', 0), ('Pop', 679), ('Regae', 23), \
            ('Rock', 5638), ('RockaBilly', 32), ('Soul', 32), ('Talk', 1), ('TestGenre', 3), ('TexMex', 218), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 5226), ('Download', 3414), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
