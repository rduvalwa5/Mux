...
songs_count = 10674
artist_count = 523
artist_albums_count = 1105
folk_songs = 677
folk_albums = 51
get_max_index_artist = 524
get_max_index_albums = 1109
get_max_index_songs = 10678
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 803), ('Classical', 59), ('Country', 974), \
            ('Easy Listening', 28), ('Folk', 677), ('Holiday', 0), ('Jazz', 860), ('Latino', 0), ('Pop', 691), ('Regae', 23), \
            ('Rock', 5790), ('RockaBilly', 32), ('Soul', 32), ('Talk', 1), ('TestGenre', 3), ('TexMex', 218), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 5412), ('Download', 3414), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
