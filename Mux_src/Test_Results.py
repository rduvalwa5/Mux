...
songs_count = 9864
artist_count = 505
artist_albums_count = 1037
folk_songs = 677
folk_albums = 50
get_max_index_artist = 506
get_max_index_albums = 1038
get_max_index_songs = 9867
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 950), \
            ...
            ('Rock', 5142), ('RockaBilly', 32), ('Soul', 32), ('Talk', 1), ('TestGenre', 3), ('TexMex', 218), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 4624), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
