...
genreList = [('Alternative',3),('BlueGrass',157),('Blues',465),('Classical',43),('Country',825), \
            ('Easy Listening',28),('Folk',599),('Holiday',97),('Jazz',762),('Latino',1),('Pop',346),('Regae',23), \
            ('Rock',3876),('RockaBilly',33),('Soul',44),('Talk',1),('TestGenre',5),('TexMex',134), \
            ('Traditional',23),('World',15)]
typeList = [('CD',2892),('Download',2838),('Tape',24),('TestType',3),('Vinyl',1721)]
