...
genreList = [('Alternative',3),('BlueGrass',157),('Blues',473),('Classical',43),('Country',897), \
            ('Easy Listening',28),('Folk',614),('Holiday',97),('Jazz',775),('Latino',1),('Pop',362),('Regae',23), \
            ('Rock',4228),('RockaBilly',32),('Soul',44),('Talk',1),('TestGenre',3),('TexMex',134), \
            ('Traditional',23),('World',15)]
typeList = [('CD',2984),('Download',3179),('Tape',24),('TestType',3),('Vinyl',1763)]
