...
folk_songs = 615
folk_albums = 47
get_max_index_artist = 481
get_max_index_albums = 936
get_max_index_songs = 8515
...
# 1064
# XXX get_artist_albums = ((188, 'Ten Years After', 'A Space In Time', 'Blues', 'Download', None, None), (665, 'Ten Years After', 'Recorded Live', 'Blues', 'Download', None, None), (666, 'Ten Years After', 'Undead (Remastered) [Live]', 'Rock', 'Download', None, None), (1064, 'Ten Years After', 'Stonedhenge (Re-Presents)', 'Rock', 'Download', None, None))
get_artist_albums = ((185, 'Ten Years After', 'Stonedhenge (Re-Presents)', 'Rock', 'Download', None, None), (186, 'Ten Years After', 'Recorded Live', 'Blues', 'Download', None, None), (187, 'Ten Years After', 'Undead (Remastered) [Live]', 'Rock', 'Download', None, None), (188, 'Ten Years After', 'A Space In Time', 'Blues', 'Download', None, None))
...
genreList = [('Alternative', 3), ('BlueGrass', 157), ('Blues', 440), ('Classical', 43), ('Country', 879), \
            ('Easy Listening', 28), ('Folk', 615), ('Holiday', 97), ('Jazz', 780), ('Latino', 1), ('Pop', 444), ('Regae', 23), \
            ('Rock', 4747), ('RockaBilly', 32), ('Soul', 44), ('Talk', 1), ('TestGenre', 3), ('TexMex', 155), \
            ('Traditional', 23), ('World', 1)]
typeList = [('CD', 3351), ('Download', 3377), ('Tape', 24), ('TestType', 3), ('Vinyl', 1761)]
