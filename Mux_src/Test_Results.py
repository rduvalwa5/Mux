...
songs_count = 9744
artist_count = 504
artist_albums_count = 1028
folk_songs = 677
folk_albums = 51
get_max_index_artist = 504
get_max_index_albums = 1029
get_max_index_songs = 9747
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 950), \
            ('Easy Listening', 28), ('Folk', 677), ('Holiday', 0), ('Jazz', 797), ('Latino', 0), ('Pop', 646), ('Regae', 23), \
            ('Rock', 5148), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 218), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 4504), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
