...
songs_count = 7205
artist_count = 560
artist_albums_count = 889
folk_songs = 599
folk_albums = 45
get_max_index_artist = 589
get_max_index_albums = 1013
get_max_index_songs = 7244
...
get_artist_albums = ((664, 'Ten Years After', 'A Space In Time', 'Blues', 'Download', None, None), (665, 'Ten Years After', 'Recorded Live', 'Blues', 'Download', None, None), (666, 'Ten Years After', 'Undead (Remastered) [Live]', 'Rock', 'Download', None, None))
...
genreList = [('Alternative',3),('BlueGrass',157),('Blues',434),('Classical',43),('Country',740), \
            ('Easy Listening',28),('Folk',599),('Holiday',97),('Jazz',752),('Latino',1),('Pop',346),('Regae',23), \
            ('Rock',3727),('RockaBilly',33),('Soul',44),('Talk',1),('TestGenre',5),('TexMex',134), \
            ('Traditional',23),('World',15)]
typeList = [('CD',2617),('Download',2838),('Tape',24),('TestType',3),('Vinyl',1721)]
