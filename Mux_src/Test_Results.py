...
songs_count = 8664
artist_count = 485
artist_albums_count = 943
folk_songs = 654
folk_albums = 50
get_max_index_artist = 485
get_max_index_albums = 944
get_max_index_songs = 8665
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 893), \
            ('Easy Listening', 28), ('Folk', 654), ('Holiday', 0), ('Jazz', 774), ('Latino', 0), ('Pop', 522), ('Regae', 23), \
            ('Rock', 4311), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 202), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 3477), ('Download', 3375), ('Tape', 24), ('TestType', 3), ('Vinyl', 1785)]
