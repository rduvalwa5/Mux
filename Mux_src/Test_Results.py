...
songs_count = 12046
artist_count = 564
artist_albums_count = 1274
folk_songs = 740
folk_albums = 64
get_max_index_artist = 606
get_max_index_albums = 10011
get_max_index_songs = 100136
...
genreList = [('Alternative',338),('Audio Book',81),('Audiobooks',2),('Blue Grass',192),('Blues',1123),('Classical',119),('Country',1101),('Folk',740),('French Pop',78),('Jazz',827),('New Age',46),('Pop',794),('R&B',577),('Reggae',24),('Rock',5684),('RockaBilly',32),('Soundtrack',89),('Talk',1),('Test Genre song',1),('TestGenre',3),('TexMex',194)]

typeList = [('CD', 6256), ('Download', 3695), ('Tape',101), ('TestType', 3), ('Vinyl', 1980)]
