...
songs_count = 10258
artist_count = 512
artist_albums_count = 1069
folk_songs = 677
folk_albums = 50
get_max_index_artist = 513
get_max_index_albums = 1070
get_max_index_songs = 10261
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 964), \
            ('Easy Listening', 28), ('Folk', 677), ('Holiday', 0), ('Jazz', 797), ('Latino', 0), ('Pop', 679), ('Regae', 23), \
            ('Rock', 5489), ('RockaBilly', 32), ('Soul', 32), ('Talk', 1), ('TestGenre', 3), ('TexMex', 218), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 4998), ('Download', 3412), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
