...
songs_count = 9041
artist_count = 491
artist_albums_count = 971
folk_songs = 677
folk_albums = 51
get_max_index_artist = 491
get_max_index_albums = 972
get_max_index_songs = 9042
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 893), \
            ('Easy Listening', 28), ('Folk', 677), ('Holiday', 0), ('Jazz', 781), ('Latino', 0), ('Pop', 548), ('Regae', 23), \
            ('Rock', 4632), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 202), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 3807), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1815)]
