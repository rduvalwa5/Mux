...
songs_count = 9320
artist_count = 495
artist_albums_count = 995
folk_songs = 686
folk_albums = 52
get_max_index_artist = 495
get_max_index_albums = 996
get_max_index_songs = 9323
...
genreList = [('Alternative', 0), ('BlueGrass', 179), ('Blues', 785), ('Classical', 59), ('Country', 939), \
            ('Easy Listening', 28), ('Folk', 686), ('Holiday', 0), ('Jazz', 787), ('Latino', 0), ('Pop', 573), ('Regae', 23), \
            ('Rock', 4825), ('RockaBilly', 32), ('Soul', 198), ('Talk', 1), ('TestGenre', 3), ('TexMex', 202), \
            ('Traditional', 0), ('World', 0)]
typeList = [('CD', 4080), ('Download', 3392), ('Tape', 24), ('TestType', 3), ('Vinyl', 1821)]
