...
#            mux.set_safe_update_delete()
            ...
            expected = ((1039, 'Test_Crud_Artist', 'Test_Crud_Album', 'Test_Crud_Genre', 'Test_Crud_Type', 'Test_Crud_cover', 99999),)
...
#            mux.set_safe_update_delete()
            ...
            print(result)
            expected =  ((1039, 'Test_Crud_Artist', 'Test_Album_Name_Crud', 'Test_Crud_Genre', 'Test_Crud_Type', 'Test_Crud_cover', 99999),)
