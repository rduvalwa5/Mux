...
#            clean up
        ...
        def test_album_update_album_cover(self):  
            ...
            result =  mux.get_album(album)
            print(result)
            expected =  ((1085, 'Test_Crud_Artist', 'Test_Crud_Album', 'Test_Crud_Genre', 'Test_Crud_Type', 'Test_Crud_cover.jpg', None),)
        ...
        def test_album_update_album_cover_idx(self):  
            ...
            result =  mux.get_album(album)
            print(result)
            expected =  ((1085, 'Test_Crud_Artist', 'Test_Crud_Album', 'Test_Crud_Genre', 'Test_Crud_Type', 'Test_Crud_cover.jpg', 999999),)
            self.assertEqual(expected, result, "album update failure")    
